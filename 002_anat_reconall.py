...
#preprocess_anatomical(population =hannover_a[0:5], afs_dir = tourettome_afs, workspace = tourettome_workspace, freesurfer_dir= fsdir)
...
#preprocess_anatomical(population =hannover_a[10:15], afs_dir = tourettome_afs, workspace = tourettome_workspace, freesurfer_dir= fsdir)
...
preprocess_anatomical(population =leipzig[0:5], afs_dir = tourettome_afs, workspace = tourettome_workspace, freesurfer_dir= fsdir)
...
# preprocess_anatomical(population =leipzig[50:55], afs_dir = tourettome_afs, workspace = tourettome_workspace, freesurfer_dir= fsdir)
