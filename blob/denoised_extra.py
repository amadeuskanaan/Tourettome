...
def nuisance_signal_regression(population, workspace_dir):
    ...
    for subject in population:
        ...
        def denoise(denoise_type, data, selector, wmsig  = wmsig, csfsig = csfsig, gmsig  = gmsig):
            ...
            if not os.path.isfile(os.path.join(run_dir, 'residual_bp_z_rhxx.mgh')):
        ...
        # 2- Detrend (Linear-Quadratic + Motion-24 +  Compcor n5
...
# nuisance_signal_regression(['PA060'], tourettome_workspace)
