__author__ = 'kanaan 23.04.2017.........HAWAIIII!! '
...
def quality_control(population, workspace):
    ...
    for subject in population:
        ...
        #output
        qcdir = mkdir_path(os.path.join(subdir, 'SEVILLA'))
        os.chdir(qcdir)
...
tourettome_workspace  = '/Users/kanaan/SCR/workspace/Tourettome'

quality_control(['HB027'], tourettome_workspace)